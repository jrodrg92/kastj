...
import { parseEther, formatEther, parseUnits, formatUnits } from "../lib/currencyUtils";
...
export function HomeClient() {
  ...
  async function handleCreate() {
    ...
    try {
      // 🚀 Use Server Action for validation and metadata prep
          ...
          <div className="premium-glass relative z-30 flex flex-col gap-4 rounded-3xl p-6 md:flex-row md:items-center">
            <div className="relative flex-1">
              <input
                ...
                className="premium-glass h-14 w-full rounded-2xl border-white/10 p-4 pl-12 outline-none transition focus:border-emerald-500/50 focus:ring-1 focus:ring-emerald-500/50 shadow-md bg-background/40"
              />
          ...
          {wallet.connected &&
            ...
            !proposalsQuery.isLoading && (
              <div className="premium-glass rounded-3xl p-16 text-center">
                ...
                <p className="mt-2 text-muted-foreground">{t.tryAdjustFilters}</p>
              </div>
            )}
