  ...
  return (
    <section className="mb-12">
      <div className="mb-6 flex items-center gap-3">
        ...
        <h2 className="text-xl font-bold text-white">{t.aboutProject || "About this project"}</h2>
      </div>
      
      <div className="premium-glass rounded-3xl border-white/[0.05] p-8 text-lg leading-relaxed text-muted-foreground shadow-xl">
        <p className="whitespace-pre-wrap">{description}</p>
        
        {!description && (
          <div className="flex flex-col items-center justify-center py-12 text-center">
            <div className="mb-4 h-16 w-16 rounded-full bg-white/5 p-4 text-white/20">
