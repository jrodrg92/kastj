...
export const DECIMALS = {
  KAS_L1: 8,   // Kaspa Native L1 (Sompi)
  IKAS_L2: 18,  // Kasplex zkEVM Native (iKAS/EVM)
  ETH: 18,
  USDT: 6,
};
...
/** Specific helpers for zkEVM Native (L2) */
export function parseIKAS(value: string): bigint {
  return parseUnits(value, DECIMALS.IKAS_L2);
}

export function formatIKAS(value: bigint | string | number): string {
  return formatUnits(value, DECIMALS.IKAS_L2);
}
