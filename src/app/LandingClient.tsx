        ...
        <ScrollReveal>
          <section className="premium-glass rounded-[3rem] p-8 md:p-16 border-white/[0.04] bg-gradient-to-br from-cyan-500/[0.03] to-transparent">
            <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
              ...
              <div className="relative aspect-square max-w-sm mx-auto lg:ml-auto group">
                {/* Decorative glows */}
                ...
                {/* Main Card */}
                <div className="premium-glass relative z-10 h-full w-full overflow-hidden rounded-[3rem] border-white/10 shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
                  {/* The generated 3D Illustration */}
                  <div className="h-2/3 w-full p-4">
                    <img 
                      src="/community_driven.png" 
                      alt="Community Driven"
                      className="h-full w-full object-contain drop-shadow-[0_0_30px_rgba(6,182,212,0.3)] transition-transform duration-700 group-hover:scale-110"
                    />
                  </div>
                  
                  {/* Text Content */}
                  <div className="h-1/3 w-full flex flex-col items-center justify-center p-8 text-center bg-gradient-to-t from-black/80 to-transparent">
                    <p className="text-2xl font-black text-white tracking-tight">{t.communityDriven}</p>
                    <p className="mt-2 text-sm text-zinc-400 font-medium leading-relaxed">{t.communityDrivenDesc}</p>
                  </div>
                </div>
              </div>
            </div>
